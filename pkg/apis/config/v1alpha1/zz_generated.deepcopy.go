...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Interpretation) DeepCopyInto(out *Interpretation) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Interpretation.
func (in *Interpretation) DeepCopy() *Interpretation {
	if in == nil {
		return nil
	}
	out := new(Interpretation)
