...
type ProxyV1alpha1Interface interface {
	...
	GlobalResourcesGetter
}

// ProxyV1alpha1Client is used to interact with features provided by the proxy.karmada.io group.
type ProxyV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ProxyV1alpha1Client) GlobalResources() GlobalResourceInterface {
	return newGlobalResources(c)
}
