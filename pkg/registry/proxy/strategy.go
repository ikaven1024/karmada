...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	r, ok := obj.(*proxyapis.GlobalResource)
	if !ok {
		return nil, nil, fmt.Errorf("given object is not a Cluster")
	}
	return r.ObjectMeta.Labels, SelectableFields(r), nil
}

// MatchGlobalResource is the filter used by the generic etcd backend to watch events
// from etcd to clients of the apiserver only interested in specific labels/fields.
func MatchGlobalResource(label labels.Selector, field fields.Selector) storage.SelectionPredicate {
...
func SelectableFields(obj *proxyapis.GlobalResource) fields.Set {
...
func (Strategy) GetResetFields() map[fieldpath.APIVersion]*fieldpath.Set {
	return map[fieldpath.APIVersion]*fieldpath.Set{
		// "proxy.karmada.io/v1alpha1": fieldpath.NewSet(
